...
// Connect to MongoDB. Uses MONGO_URI from environment if present,
// otherwise falls back to a local MongoDB instance.
export const connectDB = async () => {
    const uri = process.env.MONGO_URI || 'mongodb://localhost:27017/foodiefrenzy';
    try {
        ...
        // Exit so the process manager (nodemon) will show failure; developer can fix env.
        process.exit(1);
    }
};
...
// 6. Add it to backend/.env as: MONGO_URI="mongodb+srv://<user>:<pass>@cluster0.../dbname?retryWrites=true&w=majority"
