// Simple verification script to check if Vercel deployment is working
import axios from 'axios';

// Configuration - update these URLs with your actual deployment URLs
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://foodiefrenzy-frontend.vercel.app';
const ADMIN_URL = process.env.ADMIN_URL || 'https://foodiefrenzy-admin.vercel.app';
const BACKEND_URL = process.env.BACKEND_URL || 'https://lakeshoreconveniencee-backend-production.up.railway.app';

async function verifyDeployment() {
  console.log('=== FoodieFrenzy Vercel Deployment Verification ===');
