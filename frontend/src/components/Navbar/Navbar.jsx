          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <div className="bg-white p-1 rounded-full">
                <img className="h-10 w-10 rounded-full object-contain" src={LakeshoreLogo} alt="Lakeshore Convenience" />
              </div>
              <span className="ml-3 text-xl font-bold font-serif text-white hidden sm:block">Lakeshore Convenience</span>
            </div>
            ...
            <div className="flex items-center">
              {/* Cart */}
              <NavLink to="/cart" className="relative p-2 rounded-full hover:bg-white/20 transition-colors">
                <FiShoppingCart className="h-6 w-6" />
                {totalItems > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#FFC107] text-[#333333] text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                    {totalItems}
                  </span>
                )}
              </NavLink>
              ...
              {isAuthenticated ? (
                <button
                  ...
                  className="ml-4 px-3 py-2 rounded-md text-sm font-medium bg-white text-[#8BC34A] hover:bg-gray-100 transition-colors flex items-center"
                >
              ...
              <button
                ...
                className="md:hidden ml-4 p-2 rounded-md text-white hover:bg-white/20 focus:outline-none"
              >
                {isOpen ? (
