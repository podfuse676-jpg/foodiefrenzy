            ...
            <form onSubmit={handleSearch} className="relative max-w-2xl mx-auto md:mx-0 group">
              <div className="relative flex items-center bg-white/80 rounded-xl border-2 border-[#8BC34A]/30 shadow-2xl hover:border-[#FFC107]/50 transition-all duration-300">
                <div className="pl-6 pr-3 py-4">
                  <FaSearch className="text-xl text-[#8BC34A]/80" />
                </div>
                <input
                  type="text"
                  value={searchQuery}
                  ...
                  className="w-full py-4 pr-6 bg-transparent outline-none placeholder-gray-500 text-lg font-medium tracking-wide"
                />
                <button
                  type="submit"
                  className="mr-4 px-6 py-3 bg-gradient-to-r from-[#8BC34A] to-[#FFC107] rounded-lg font-semibold text-white hover:from-[#FFC107] hover:to-[#8BC34A] transition-all duration-300 shadow-lg hover:shadow-[#FFC107]/20"
                >
                  Search
                </button>
              </div>
